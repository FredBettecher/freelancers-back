...
function userRegistration(email, password) {
    return __awaiter(this, void 0, void 0, function () {
        var emailExists, newUser;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, users_repository_1.default.findByEmail(email)];
                case 1:
                    emailExists = _a.sent();
                    if (emailExists)
                        throw (0, errors_1.duplicatedEmailError)();
                    return [4 /*yield*/, users_repository_1.default.createUser(email, password)];
                case 2:
                    newUser = _a.sent();
